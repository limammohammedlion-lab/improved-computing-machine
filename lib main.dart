...
void main() async {
  ...
  // تهيئة الإشعارات الأساسية (يمكن تفعيله عند ربط Firebase كاملاً)
  try {
    await Firebase.initializeApp();
  } catch (e) {
    print('تنبيه التهيئة: $e');
  }
...
// ==========================================
// 2. الشاشة الرئيسية مع الإشعارات (HomeScreen)
// ==========================================
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _initFCMListeners() {
    // استقبال الإشعارات الفورية والتطبيق مفتوح
    try {
      FirebaseMessaging.onMessage.listen((RemoteMessage message) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            backgroundColor: Colors.amber[800],
            content: Text('إشعار جديد: ${message.notification?.title ?? "طلب خدمة عاجل"}'),
          ),
        );
      });
    } catch (_) {}
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                                ...
                                const SnackBar(
                                  ...
                                  content: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          'تم قبول المهمة! أُرسل إشعار فوري لصاحب الطلب ورقم هاتفه متاح الآن.',
                            ...
                            child: const Text('قبول المهمة والتواصل الفوري', style: TextStyle(color: Colors.white)),
                          ),
                        ),
                      ],
                    ),
        ...
        child: Column(
          children: [
            ...
            ElevatedButton.icon(
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('جاري التسجيل الصوتي... تحدث الآن')),
                );
              },
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('نشر الطلب وإرسال إشعار فوري', style: TextStyle(color: Colors.white, fontSize: 16)),
              ),
            )
          ],
        ),
